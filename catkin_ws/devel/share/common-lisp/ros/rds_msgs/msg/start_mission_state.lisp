...
(cl:defmethod cl:initialize-instance :after ((m <start_mission_state>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'start_mission_state)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name rds_msgs-msg:<start_mission_state> is deprecated: use rds_msgs-msg:start_mission_state instead.")))
