...
(cl:defmethod cl:initialize-instance :after ((m <BoundBox>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'BoundBox)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name foresight_outputs-msg:<BoundBox> is deprecated: use foresight_outputs-msg:BoundBox instead.")))

(cl:ensure-generic-function 'BottomRightX-val :lambda-list '(m))
(cl:defmethod BottomRightX-val ((m <BoundBox>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader foresight_outputs-msg:BottomRightX-val is deprecated.  Use foresight_outputs-msg:BottomRightX instead.")
  (BottomRightX m))

(cl:ensure-generic-function 'BottomRightY-val :lambda-list '(m))
(cl:defmethod BottomRightY-val ((m <BoundBox>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader foresight_outputs-msg:BottomRightY-val is deprecated.  Use foresight_outputs-msg:BottomRightY instead.")
  (BottomRightY m))

(cl:ensure-generic-function 'TopLeftX-val :lambda-list '(m))
(cl:defmethod TopLeftX-val ((m <BoundBox>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader foresight_outputs-msg:TopLeftX-val is deprecated.  Use foresight_outputs-msg:TopLeftX instead.")
  (TopLeftX m))

(cl:ensure-generic-function 'TopLeftY-val :lambda-list '(m))
(cl:defmethod TopLeftY-val ((m <BoundBox>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader foresight_outputs-msg:TopLeftY-val is deprecated.  Use foresight_outputs-msg:TopLeftY instead.")
  (TopLeftY m))
