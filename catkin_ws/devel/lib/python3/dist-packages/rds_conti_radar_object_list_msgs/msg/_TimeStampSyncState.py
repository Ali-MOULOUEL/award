...
"""autogenerated by genpy from rds_conti_radar_object_list_msgs/TimeStampSyncState.msg. Do not edit."""
import codecs
import sys
...
class TimeStampSyncState(genpy.Message):
  _md5sum = "951c6e7c01586103049a126c68595609"
  _type = "rds_conti_radar_object_list_msgs/TimeStampSyncState"
  _has_header = False  # flag to mark the presence of a Header object
  _full_text = """#MsgHeader field TimeStampSyncState
...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(TimeStampSyncState, self).__init__(*args, **kwds)
      # message fields cannot be None, assign default values for those that are
      if self.TimeStampSyncState is None:
        self.TimeStampSyncState = 0
    else:
      self.TimeStampSyncState = 0
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.TimeStampSyncState,) = _get_struct_B().unpack(str[start:end])
      return self
