...
(cl:defmethod cl:initialize-instance :after ((m <motion>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'motion)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name rds_anticollision-msg:<motion> is deprecated: use rds_anticollision-msg:motion instead.")))
