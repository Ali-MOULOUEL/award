...
(cl:defmethod cl:initialize-instance :after ((m <error>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'error)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name rds_anticollision-msg:<error> is deprecated: use rds_anticollision-msg:error instead.")))

(cl:ensure-generic-function 'category-val :lambda-list '(m))
(cl:defmethod category-val ((m <error>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rds_anticollision-msg:category-val is deprecated.  Use rds_anticollision-msg:category instead.")
  (category m))

(cl:ensure-generic-function 'value-val :lambda-list '(m))
(cl:defmethod value-val ((m <error>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rds_anticollision-msg:value-val is deprecated.  Use rds_anticollision-msg:value instead.")
  (value m))
