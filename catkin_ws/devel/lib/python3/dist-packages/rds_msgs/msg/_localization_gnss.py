...
"""autogenerated by genpy from rds_msgs/localization_gnss.msg. Do not edit."""
import codecs
import sys
...
class localization_gnss(genpy.Message):
  _md5sum = "7f5e4523115c22b0b204c6ef79abd94a"
  _type = "rds_msgs/localization_gnss"
...
"""
  __slots__ = ['header','pose','detail']
  _slot_types = ['std_msgs/Header','geometry_msgs/PoseWithCovariance','rds_msgs/localization_gnss_detail']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(localization_gnss, self).__init__(*args, **kwds)
      ...
      if self.detail is None:
        self.detail = rds_msgs.msg.localization_gnss_detail()
    else:
      self.header = std_msgs.msg.Header()
      self.pose = geometry_msgs.msg.PoseWithCovariance()
      self.detail = rds_msgs.msg.localization_gnss_detail()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_get_struct_HIbf3B().pack(_x.detail.date_week, _x.detail.date_millisecs, _x.detail.mode.mode, _x.detail.correction_age, _x.detail.num_sat_tracked, _x.detail.num_sat_used_l1, _x.detail.num_sat_used_l1l2))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.detail.date_week, _x.detail.date_millisecs, _x.detail.mode.mode, _x.detail.correction_age, _x.detail.num_sat_tracked, _x.detail.num_sat_used_l1, _x.detail.num_sat_used_l1l2,) = _get_struct_HIbf3B().unpack(str[start:end])
      return self
...
def _get_struct_7d():
    ...
    return _struct_7d
_struct_HIbf3B = None
def _get_struct_HIbf3B():
    global _struct_HIbf3B
    if _struct_HIbf3B is None:
        _struct_HIbf3B = struct.Struct("<HIbf3B")
    return _struct_HIbf3B
