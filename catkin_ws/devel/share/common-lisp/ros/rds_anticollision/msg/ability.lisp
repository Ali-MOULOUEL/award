...
(cl:defmethod cl:initialize-instance :after ((m <ability>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ability)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name rds_anticollision-msg:<ability> is deprecated: use rds_anticollision-msg:ability instead.")))

(cl:ensure-generic-function 'ability-val :lambda-list '(m))
(cl:defmethod ability-val ((m <ability>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rds_anticollision-msg:ability-val is deprecated.  Use rds_anticollision-msg:ability instead.")
  (ability m))
