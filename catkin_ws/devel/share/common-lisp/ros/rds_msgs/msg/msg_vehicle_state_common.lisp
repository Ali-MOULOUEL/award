...
(cl:defclass <msg_vehicle_state_common> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (drive_mode
    :reader drive_mode
    :initarg :drive_mode
    :type rds_msgs-msg:drive_mode
    :initform (cl:make-instance 'rds_msgs-msg:drive_mode))
   (motion
    :reader motion
    :initarg :motion
    :type rds_msgs-msg:motion
    :initform (cl:make-instance 'rds_msgs-msg:motion))
   (emergency_stop_root_causes
    :reader emergency_stop_root_causes
    :initarg :emergency_stop_root_causes
    :type rds_msgs-msg:emergency_stop_root_cause
    :initform (cl:make-instance 'rds_msgs-msg:emergency_stop_root_cause))
   (errors
    :reader errors
    :initarg :errors
    :type (cl:vector rds_msgs-msg:error)
   :initform (cl:make-array 0 :element-type 'rds_msgs-msg:error :initial-element (cl:make-instance 'rds_msgs-msg:error)))
   (warnings
    :reader warnings
    :initarg :warnings
    :type (cl:vector rds_msgs-msg:error)
   ...
   (safety_chain_state
    ...
    :type rds_msgs-msg:safety_chain_state
    :initform (cl:make-instance 'rds_msgs-msg:safety_chain_state))
   (controller_status
    :reader controller_status
    :initarg :controller_status
    :type rds_msgs-msg:ability
    :initform (cl:make-instance 'rds_msgs-msg:ability))
   (engagement_ability
   ...
   (start_mission_state
    ...
    :type rds_msgs-msg:start_mission_state
    :initform (cl:make-instance 'rds_msgs-msg:start_mission_state)))
)
...
(cl:defmethod cl:initialize-instance :after ((m <msg_vehicle_state_common>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'msg_vehicle_state_common)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name rds_msgs-msg:<msg_vehicle_state_common> is deprecated: use rds_msgs-msg:msg_vehicle_state_common instead.")))
...
(cl:defmethod drive_mode-val ((m <msg_vehicle_state_common>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rds_msgs-msg:drive_mode-val is deprecated.  Use rds_msgs-msg:drive_mode instead.")
  (drive_mode m))
...
(cl:defmethod emergency_stop_root_causes-val ((m <msg_vehicle_state_common>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rds_msgs-msg:emergency_stop_root_causes-val is deprecated.  Use rds_msgs-msg:emergency_stop_root_causes instead.")
...
(cl:defmethod errors-val ((m <msg_vehicle_state_common>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rds_msgs-msg:errors-val is deprecated.  Use rds_msgs-msg:errors instead.")
  (errors m))

(cl:ensure-generic-function 'warnings-val :lambda-list '(m))
(cl:defmethod warnings-val ((m <msg_vehicle_state_common>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rds_msgs-msg:warnings-val is deprecated.  Use rds_msgs-msg:warnings instead.")
  (warnings m))
...
(cl:defmethod safety_chain_state-val ((m <msg_vehicle_state_common>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rds_msgs-msg:safety_chain_state-val is deprecated.  Use rds_msgs-msg:safety_chain_state instead.")
...
(cl:defmethod controller_status-val ((m <msg_vehicle_state_common>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rds_msgs-msg:controller_status-val is deprecated.  Use rds_msgs-msg:controller_status instead.")
  (controller_status m))
...
(cl:defmethod engagement_ability-val ((m <msg_vehicle_state_common>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rds_msgs-msg:engagement_ability-val is deprecated.  Use rds_msgs-msg:engagement_ability instead.")
...
(cl:defmethod start_mission_state-val ((m <msg_vehicle_state_common>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rds_msgs-msg:start_mission_state-val is deprecated.  Use rds_msgs-msg:start_mission_state instead.")
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <msg_vehicle_state_common>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'errors)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'rds_msgs-msg:error))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<msg_vehicle_state_common>)))
  ...
  "rds_msgs/msg_vehicle_state_common")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'msg_vehicle_state_common)))
  "Returns string type for a message object of type 'msg_vehicle_state_common"
  "rds_msgs/msg_vehicle_state_common")
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<msg_vehicle_state_common>)))
  ...
  (cl:format cl:nil "Header header~%~%drive_mode drive_mode~%~%motion motion~%emergency_stop_root_cause emergency_stop_root_causes~%error[] errors~%error[] warnings~%~%safety_chain_state safety_chain_state~%ability controller_status~%ability engagement_ability~%start_mission_state start_mission_state~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%================================================================================~%MSG: rds_msgs/drive_mode~%uint8 DRIVE_MODE_MANUAL = 0 ~%uint8 DRIVE_MODE_AUTOMATIC = 1~%uint8 DRIVE_MODE_TELEOPERATION = 2~%~%uint8 drive_mode~%~%================================================================================~%MSG: rds_msgs/motion~%# Motion type~%uint8 MOTION_UNKNOWN = 0~%uint8 MOTION_MOVING = 1~%uint8 MOTION_NULL_SPEED = 2~%uint8 MOTION_PARKED = 3~%~%uint8 motion~%~%================================================================================~%MSG: rds_msgs/emergency_stop_root_cause~%error[] causes~%~%# Vehicle Context when fired~%float32 speed~%~%~%================================================================================~%MSG: rds_msgs/error~%# Generic error~%# Value field equals 0 means no error (whatever category is set to)~%uint32 category~%int32 value~%~%~%================================================================================~%MSG: rds_msgs/safety_chain_state~%uint8 STATE_ACTIVE = 0~%uint8 STATE_DISABLED = 1~%uint8 STATE_FAILSOFT = 2~%~%uint8 state~%~%================================================================================~%MSG: rds_msgs/ability~%int8 ABILITY_NOT_APPLICABLE = -1~%int8 ABILITY_NOT_AVAILABLE = 0 ~%int8 ABILITY_TRUE = 1~%int8 ABILITY_FALSE = 2~%~%int8 ability~%~%================================================================================~%MSG: rds_msgs/start_mission_state~%uint8 STATE_NOT_SUPPORTED = 0~%uint8 STATE_NOT_TRIGGERABLE = 1~%uint8 STATE_TRIGGERABLE = 2~%uint8 STATE_TRIGGERED = 3~%~%uint8 state~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'msg_vehicle_state_common)))
  "Returns full string definition for message of type 'msg_vehicle_state_common"
  (cl:format cl:nil "Header header~%~%drive_mode drive_mode~%~%motion motion~%emergency_stop_root_cause emergency_stop_root_causes~%error[] errors~%error[] warnings~%~%safety_chain_state safety_chain_state~%ability controller_status~%ability engagement_ability~%start_mission_state start_mission_state~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%================================================================================~%MSG: rds_msgs/drive_mode~%uint8 DRIVE_MODE_MANUAL = 0 ~%uint8 DRIVE_MODE_AUTOMATIC = 1~%uint8 DRIVE_MODE_TELEOPERATION = 2~%~%uint8 drive_mode~%~%================================================================================~%MSG: rds_msgs/motion~%# Motion type~%uint8 MOTION_UNKNOWN = 0~%uint8 MOTION_MOVING = 1~%uint8 MOTION_NULL_SPEED = 2~%uint8 MOTION_PARKED = 3~%~%uint8 motion~%~%================================================================================~%MSG: rds_msgs/emergency_stop_root_cause~%error[] causes~%~%# Vehicle Context when fired~%float32 speed~%~%~%================================================================================~%MSG: rds_msgs/error~%# Generic error~%# Value field equals 0 means no error (whatever category is set to)~%uint32 category~%int32 value~%~%~%================================================================================~%MSG: rds_msgs/safety_chain_state~%uint8 STATE_ACTIVE = 0~%uint8 STATE_DISABLED = 1~%uint8 STATE_FAILSOFT = 2~%~%uint8 state~%~%================================================================================~%MSG: rds_msgs/ability~%int8 ABILITY_NOT_APPLICABLE = -1~%int8 ABILITY_NOT_AVAILABLE = 0 ~%int8 ABILITY_TRUE = 1~%int8 ABILITY_FALSE = 2~%~%int8 ability~%~%================================================================================~%MSG: rds_msgs/start_mission_state~%uint8 STATE_NOT_SUPPORTED = 0~%uint8 STATE_NOT_TRIGGERABLE = 1~%uint8 STATE_TRIGGERABLE = 2~%uint8 STATE_TRIGGERED = 3~%~%uint8 state~%~%~%"))
