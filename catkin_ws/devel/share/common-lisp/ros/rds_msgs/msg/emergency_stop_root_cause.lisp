...
(cl:defmethod cl:initialize-instance :after ((m <emergency_stop_root_cause>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'emergency_stop_root_cause)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name rds_msgs-msg:<emergency_stop_root_cause> is deprecated: use rds_msgs-msg:emergency_stop_root_cause instead.")))

(cl:ensure-generic-function 'causes-val :lambda-list '(m))
(cl:defmethod causes-val ((m <emergency_stop_root_cause>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rds_msgs-msg:causes-val is deprecated.  Use rds_msgs-msg:causes instead.")
  (causes m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<emergency_stop_root_cause>)))
  ...
  "rds_msgs/emergency_stop_root_cause")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'emergency_stop_root_cause)))
  "Returns string type for a message object of type 'emergency_stop_root_cause"
  "rds_msgs/emergency_stop_root_cause")
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<emergency_stop_root_cause>)))
  ...
  (cl:format cl:nil "error[] causes~%~%# Vehicle Context when fired~%float32 speed~%~%~%================================================================================~%MSG: rds_msgs/error~%# Generic error~%# Value field equals 0 means no error (whatever category is set to)~%uint32 category~%int32 value~%~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'emergency_stop_root_cause)))
  "Returns full string definition for message of type 'emergency_stop_root_cause"
  (cl:format cl:nil "error[] causes~%~%# Vehicle Context when fired~%float32 speed~%~%~%================================================================================~%MSG: rds_msgs/error~%# Generic error~%# Value field equals 0 means no error (whatever category is set to)~%uint32 category~%int32 value~%~%~%~%"))
